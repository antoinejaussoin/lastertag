...
pub struct Screen {
    ...
    temp: MonoTextStyle<'static, BinaryColor>,
}
...
impl Screen {
    ...
    pub fn show(&mut self, temp_line: &str, status: &str) {
        ...
        .unwrap();
        Text::with_baseline(temp_line, Point::new(8, 24), self.temp, Baseline::Top)
            .draw(&mut self.display)
            .unwrap();
